...
# Stock postrm above (afterRemove replaces it, same as afterInstall). Take the udev rule back out so
# removing the package leaves no device permissions behind.
