...
- **`bedrock-panel_amd64.deb`** — Linux x64 for Debian and Ubuntu (**v0.9.6-beta.1, tester beta**):
  ...
  [docs/releases/v0.9.6-beta.1-linux.md](docs/releases/v0.9.6-beta.1-linux.md).
